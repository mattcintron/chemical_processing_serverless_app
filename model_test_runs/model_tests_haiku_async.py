...
chemicals = [{"Number": "N04010", "Part_Description": example_chemical} for _ in range(2)]
not_chemicals = [{"Number": "N04014", "Part_Description": example_not_a_chemical} for _ in range(2)]
...
async def process_batches(data_list, batch_size=2):
    """
